  ...
  useFactory: () => {
    ...
    return admin.initializeApp({
      credential: admin.credential.cert({
        ...
        client_email:
          'firebase-adminsdk-fbsvc@hr-hub-a7803.iam.gserviceaccount.com',
        ...
        client_x509_cert_url:
          'https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40hr-hub-a7803.iam.gserviceaccount.com',
